...
while (true) {
    ...
    while (!(inspectionCode == 0)) {
        if (isInitialStartup) {
            System.out.println("PerpetualCalendarを起動しました。\n");
            System.out.println("==========使い方==========");
            System.out.println("受付可能な入力形式は以下です。");
            System.out.println("$ cal [month [year]]");
            System.out.println();
            System.out.println("-----例-----");
            System.out.println("$ cal          -> 現在のカレンダーが表示されます。");
            System.out.println("$ cal 12       -> 今年の12月のカレンダーを表示します。");
            System.out.println("$ cal 12 2020  -> 2020年12月のカレンダーを表示します。");
            System.out.println("------------");
            System.out.println("プログラムは q で終了します。");
            System.out.println("==========================");
            System.out.println();
        }
        System.out.print("$ ");
        ...
        if (Objects.requireNonNull(cmdLine).matches("q")) {
            System.exit(0);
        }
